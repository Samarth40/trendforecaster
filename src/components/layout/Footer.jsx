...
function Footer() {
  return (
    <footer className="bg-[#0F1629] border-t border-white/10 pt-16 pb-8">
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center mb-4 md:mb-0">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-[#4F46E5] to-[#06B6D4] flex items-center justify-center mr-3">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <span className="text-gray-400">
                © {new Date().getFullYear()} TrendForecaster. All rights reserved.
              </span>
            </div>
